    ...
    public class LocatonsController : ApiController
    {
        ...
        public List<Location> LocationByLocationId(int id)
        {
            try
            {
                ...
                strSQL = "Select LocationId, NameOfLocation from dbo.Location where LocationId=" + id + "";
        ...
        public List<Location> LocationByLocationIds(string ids)
        {
            try
            {
                ...
                strSQL = "Select LocationId, NameOfLocation from dbo.Location where LocationId in (" + ids + ")";
                List<Location> list = new List<Location>();
                thisADO.returnSingleValue(strSQL, true, ref list);
        ...
        public List<Location> Locations()
        {
            try
            {
                ...
                strSQL = "Select LocationId, NameOfLocation from dbo.Location";
                List<Location> list = new List<Location>();
                thisADO.returnSingleValue(strSQL, true, ref list);
